...
def get_scouting_report_post_2014(url):
    report = ""
    z = requests.get(url, headers=headers)
    soup = BeautifulSoup(z.text, features="lxml")
    trs = soup.find("div",{"id":"PlayerFiles"}).find("tbody").find_all("tr")
...
#get_scouting_report_pre_2014('http://insider.espn.com/college-sports/football/recruiting/player/evaluation/_/id/22510/myron-rolle')
